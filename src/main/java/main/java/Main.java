...
//
//        You can decide to store these details to a file which means if the program exits data is always available.
//        If you do this then you must load data from the file to your database
//          use pom.xml
//
//        You must use git and github for this project
